...
def train(device):
    ...
    # "CnnLstmPolicy"
    model = RecurrentPPO(custom_policy_lstm.CustomCnnLstmPolicy, env, verbose=1, gamma=0.95, n_epochs=200, learning_rate=3e-5, batch_size=64, seed=constants.RANDOM_SEED, device=device)
