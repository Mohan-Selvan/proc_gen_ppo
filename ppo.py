...
def train():
    ...
    model = PPO("CnnPolicy", create_env(), verbose=1, gamma=0.95, n_epochs=100, seed=2)

    print("Training : Start")

    # # Train the model
    model.learn(total_timesteps=50000, progress_bar=True, callback=reward_callback, reset_num_timesteps=False)
