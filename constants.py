...
OBSERVATION_WINDOW_SHAPE = (7, 7) #(36, 64)
ACTION_SPACE = 9
...
TILE_ACTION_PLACE_EMPTY_SPACE = 1
TILE_ACTION_PLACE_PLATFORM = 0
TILE_ACTION_PLACE_STONE = 3
TILE_ACTION_PLACE_LAVA = 4
TILE_ACTION_IGNORE = 2

DEFAULT_PLAYER_PATH_FILE_PATH = "./saves/path_list"